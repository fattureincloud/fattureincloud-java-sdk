  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ListReceiptsResponse.openapiRequiredFields.isEmpty()) {
        ...
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ListReceiptsResponse is not found in the empty JSON"
                    + " string",
    ...
    for (Entry<String, JsonElement> entry : entries) {
      if (!ListReceiptsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ListReceiptsResponse`"
                    + " properties. JSON: %s",
