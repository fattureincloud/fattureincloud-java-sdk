...
public class ListReceiptsResponse implements Serializable {
   ...
   * @throws IOException if the JSON Object is invalid with respect to ListReceiptsResponse
   */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ListReceiptsResponse.openapiRequiredFields.isEmpty()) {
        return;
      } else { // has required fields
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ListReceiptsResponse is not found in the empty JSON string",
                ListReceiptsResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Entry<String, JsonElement> entry : entries) {
      if (!ListReceiptsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ListReceiptsResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ListReceiptsResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ListReceiptsResponse' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ListReceiptsResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ListReceiptsResponse.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ListReceiptsResponse>() {
            @Override
            public void write(JsonWriter out, ListReceiptsResponse value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public ListReceiptsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListReceiptsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListReceiptsResponse
   * @throws IOException if the JSON string is invalid with respect to ListReceiptsResponse
   */
  public static ListReceiptsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListReceiptsResponse.class);
  }

  /**
   * Convert an instance of ListReceiptsResponse to an JSON string
   *
   * @return JSON string
   */
