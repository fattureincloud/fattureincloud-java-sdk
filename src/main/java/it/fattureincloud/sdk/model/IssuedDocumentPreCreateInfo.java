...
public class IssuedDocumentPreCreateInfo implements Serializable {
  ...
  public static final String SERIALIZED_NAME_LANGUAGES_LIST = "languages_list";

  @SerializedName(SERIALIZED_NAME_LANGUAGES_LIST)
  private List<Language> languagesList = null;
  ...
  public IssuedDocumentPreCreateInfo languagesList(List<Language> languagesList) {

    this.languagesList = languagesList;
    return this;
  }

  public IssuedDocumentPreCreateInfo addLanguagesListItem(Language languagesListItem) {
    if (this.languagesList == null) {
      this.languagesList = null;
    }
    this.languagesList.add(languagesListItem);
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.numerations, issuedDocumentPreCreateInfo.numerations)
        ...
        && Objects.equals(this.languagesList, issuedDocumentPreCreateInfo.languagesList);
  }
  ...
  static {
    ...
    openapiFields.add("languages_list");
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (!IssuedDocumentPreCreateInfo.openapiRequiredFields
    ...
    if (jsonObj.get("currencies_list") != null && !jsonObj.get("currencies_list").isJsonNull()) {
    ...
    if (jsonObj.get("templates_list") != null && !jsonObj.get("templates_list").isJsonNull()) {
    ...
    if (jsonObj.get("dn_templates_list") != null
        && !jsonObj.get("dn_templates_list").isJsonNull()) {
    ...
    if (jsonObj.get("ai_templates_list") != null
        && !jsonObj.get("ai_templates_list").isJsonNull()) {
    ...
    if (jsonObj.get("payment_methods_list") != null
        && !jsonObj.get("payment_methods_list").isJsonNull()) {
    ...
    if (jsonObj.get("languages_list") != null && !jsonObj.get("languages_list").isJsonNull()) {
      JsonArray jsonArraylanguagesList = jsonObj.getAsJsonArray("languages_list");
      if (jsonArraylanguagesList != null) {
        // ensure the json data is an array
        ...
        for (int i = 0; i < jsonArraylanguagesList.size(); i++) {
          Language.validateJsonObject(jsonArraylanguagesList.get(i).getAsJsonObject());
        }
        ;
      }
    }
