...
public class IssuedDocumentExtraData {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (IssuedDocumentExtraData.openapiRequiredFields.isEmpty()) {
        return;
    ...
    if (jsonObj.get("ts_tipo_spesa") != null && !jsonObj.get("ts_tipo_spesa").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("ts_file_id") != null && !jsonObj.get("ts_file_id").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("imported_by") != null && !jsonObj.get("imported_by").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
