...
public class IssuedDocumentEiData {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (jsonObj.get("od_number") != null && !jsonObj.get("od_number").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("cig") != null && !jsonObj.get("cig").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `cig` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("cig").toString()));
    }
    if (jsonObj.get("cup") != null && !jsonObj.get("cup").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("bank_beneficiary") != null
    ...
    if (jsonObj.get("invoice_number") != null && !jsonObj.get("invoice_number").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
