...
public class DetailedCountry {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (jsonObj.get("settings_name") != null && !jsonObj.get("settings_name").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("iso") != null && !jsonObj.get("iso").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `iso` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("iso").toString()));
    }
    if (jsonObj.get("fiscal_iso") != null && !jsonObj.get("fiscal_iso").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("uic") != null && !jsonObj.get("uic").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
