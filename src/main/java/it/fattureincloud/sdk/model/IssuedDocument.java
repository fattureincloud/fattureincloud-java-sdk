...
public class IssuedDocument implements Serializable {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (!IssuedDocument.openapiRequiredFields
    ...
    if (jsonObj.get("items_list") != null && !jsonObj.get("items_list").isJsonNull()) {
      ...
      if (jsonArrayitemsList != null) {
        ...
        for (int i = 0; i < jsonArrayitemsList.size(); i++) {
          IssuedDocumentItemsListItem.validateJsonObject(
              jsonArrayitemsList.get(i).getAsJsonObject());
        }
        ;
      }
    }
    if (jsonObj.get("payments_list") != null && !jsonObj.get("payments_list").isJsonNull()) {
