...
public class IssuedDocument implements Serializable {
   ...
   * invoice * &#x60;manual_accepted&#x60; - The customer accepted the invoice *
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "[Temporary] [Read Only]   Public url of the document PDF file.")
  ...
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "[Temporary] [Read Only]   Public url of the attached delivery note PDF file.")
  ...
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "[Temporary] [Read Only]   Public url of the accompanying invoice PDF file.")
   ...
   * attachment token is passed via POST /issued_documents or PUT /issued_documents/{documentId}.
   *
  ...
  static {
    ...
    openapiFields.add("visible_subject");
    openapiFields.add("rc_center");
    openapiFields.add("notes");
    openapiFields.add("rivalsa");
    openapiFields.add("cassa");
    openapiFields.add("amount_cassa");
    openapiFields.add("cassa_taxable");
    openapiFields.add("amount_cassa_taxable");
    openapiFields.add("cassa2");
    openapiFields.add("amount_cassa2");
    openapiFields.add("cassa2_taxable");
    openapiFields.add("amount_cassa2_taxable");
    openapiFields.add("global_cassa_taxable");
    openapiFields.add("amount_global_cassa_taxable");
    ...
    openapiFields.add("use_split_payment");
    openapiFields.add("use_gross_prices");
    openapiFields.add("e_invoice");
    openapiFields.add("ei_data");
    openapiFields.add("ei_cassa_type");
    openapiFields.add("ei_cassa2_type");
    openapiFields.add("ei_withholding_tax_causal");
    openapiFields.add("ei_other_withholding_tax_type");
    openapiFields.add("ei_other_withholding_tax_causal");
    openapiFields.add("items_list");
    openapiFields.add("payments_list");
    openapiFields.add("template");
    openapiFields.add("delivery_note_template");
    openapiFields.add("acc_inv_template");
    openapiFields.add("h_margins");
    openapiFields.add("v_margins");
    openapiFields.add("show_payments");
    openapiFields.add("show_payment_method");
    openapiFields.add("show_totals");
    openapiFields.add("show_paypal_button");
    openapiFields.add("show_notification_button");
    openapiFields.add("show_tspay_button");
    openapiFields.add("delivery_note");
    openapiFields.add("accompanying_invoice");
    openapiFields.add("dn_number");
    openapiFields.add("dn_date");
    openapiFields.add("dn_ai_packages_number");
    openapiFields.add("dn_ai_weight");
    openapiFields.add("dn_ai_causal");
    openapiFields.add("dn_ai_destination");
    openapiFields.add("dn_ai_transporter");
    openapiFields.add("dn_ai_notes");
    openapiFields.add("is_marked");
    openapiFields.add("amount_net");
    openapiFields.add("amount_vat");
    openapiFields.add("amount_gross");
    openapiFields.add("amount_due_discount");
    openapiFields.add("amount_rivalsa");
    openapiFields.add("amount_rivalsa_taxable");
    openapiFields.add("amount_withholding_tax");
    openapiFields.add("amount_withholding_tax_taxable");
    openapiFields.add("amount_other_withholding_tax");
    openapiFields.add("amount_other_withholding_tax_taxable");
    openapiFields.add("amount_enasarco_taxable");
    openapiFields.add("extra_data");
    openapiFields.add("seen_date");
    openapiFields.add("next_due_date");
    openapiFields.add("url");
    openapiFields.add("dn_url");
    openapiFields.add("ai_url");
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (IssuedDocument.openapiRequiredFields.isEmpty()) {
        ...
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in IssuedDocument is not found in the empty JSON string",
                IssuedDocument.openapiRequiredFields.toString()));
      }
    }
    ...
    if ((jsonObj.get("entity") != null && !jsonObj.get("entity").isJsonNull())
      ...
      Entity.validateJsonObject(jsonObj.getAsJsonObject("entity"));
    }
    ...
    if ((jsonObj.get("visible_subject") != null && !jsonObj.get("visible_subject").isJsonNull())
    ...
    if ((jsonObj.get("ei_data") != null && !jsonObj.get("ei_data").isJsonNull())
        && !jsonObj.get("ei_data").isJsonPrimitive()) {
      IssuedDocumentEiData.validateJsonObject(jsonObj.getAsJsonObject("ei_data"));
    }
    if ((jsonObj.get("ei_cassa_type") != null && !jsonObj.get("ei_cassa_type").isJsonNull())
    ...
    if ((jsonObj.get("ei_withholding_tax_causal") != null
            && !jsonObj.get("ei_withholding_tax_causal").isJsonNull())
    ...
    if ((jsonObj.get("ei_other_withholding_tax_type") != null
            && !jsonObj.get("ei_other_withholding_tax_type").isJsonNull())
    ...
    if ((jsonObj.get("ei_other_withholding_tax_causal") != null
            && !jsonObj.get("ei_other_withholding_tax_causal").isJsonNull())
    ...
    if (jsonArrayitemsList != null) {
      ...
      for (int i = 0; i < jsonArrayitemsList.size(); i++) {
        IssuedDocumentItemsListItem.validateJsonObject(jsonArrayitemsList.get(i).getAsJsonObject());
      }
      ;
    }
    ...
    if (jsonArraypaymentsList != null) {
      ...
      for (int i = 0; i < jsonArraypaymentsList.size(); i++) {
        IssuedDocumentPaymentsListItem.validateJsonObject(
    ...
    if ((jsonObj.get("template") != null && !jsonObj.get("template").isJsonNull())
        && !jsonObj.get("template").isJsonPrimitive()) {
      DocumentTemplate.validateJsonObject(jsonObj.getAsJsonObject("template"));
    }
    // validate the optional field `delivery_note_template`
    if ((jsonObj.get("delivery_note_template") != null
            && !jsonObj.get("delivery_note_template").isJsonNull())
        && !jsonObj.get("delivery_note_template").isJsonPrimitive()) {
      DocumentTemplate.validateJsonObject(jsonObj.getAsJsonObject("delivery_note_template"));
    }
    // validate the optional field `acc_inv_template`
    if ((jsonObj.get("acc_inv_template") != null && !jsonObj.get("acc_inv_template").isJsonNull())
        && !jsonObj.get("acc_inv_template").isJsonPrimitive()) {
      DocumentTemplate.validateJsonObject(jsonObj.getAsJsonObject("acc_inv_template"));
    }
    if ((jsonObj.get("dn_ai_packages_number") != null
            && !jsonObj.get("dn_ai_packages_number").isJsonNull())
    ...
    if ((jsonObj.get("extra_data") != null && !jsonObj.get("extra_data").isJsonNull())
        && !jsonObj.get("extra_data").isJsonPrimitive()) {
      IssuedDocumentExtraData.validateJsonObject(jsonObj.getAsJsonObject("extra_data"));
    }
    ...
    if ((jsonObj.get("dn_url") != null && !jsonObj.get("dn_url").isJsonNull())
        && !jsonObj.get("dn_url").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `dn_url` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("dn_url").toString()));
    }
    if ((jsonObj.get("ai_url") != null && !jsonObj.get("ai_url").isJsonNull())
        && !jsonObj.get("ai_url").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `ai_url` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("ai_url").toString()));
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<IssuedDocument>() {
            @Override
