...
public class IssuedDocument implements Serializable {
  ...
  private Boolean useSplitPayment = false;
  ...
  private Boolean useGrossPrices = false;
  ...
  private Boolean showPaypalButton = false;
  ...
  private Boolean showNotificationButton = false;
  ...
  private Boolean accompanyingInvoice = false;
  ...
  public static final String SERIALIZED_NAME_REFERS_TO = "refers_to";
  @SerializedName(SERIALIZED_NAME_REFERS_TO)
  private IssuedDocumentRefersTo refersTo;
  ...
  **/
  ...
  public IssuedDocument itemsList(List<IssuedDocumentItemsList> itemsList) {
    
    this.itemsList = itemsList;
    return this;
  }

  public IssuedDocument addItemsListItem(IssuedDocumentItemsList itemsListItem) {
  ...
  **/
  ...
  public List<IssuedDocumentItemsList> getItemsList() {
    return itemsList;
  }


  public void setItemsList(List<IssuedDocumentItemsList> itemsList) {
    this.itemsList = itemsList;
  }


  public IssuedDocument paymentsList(List<IssuedDocumentPaymentsList> paymentsList) {
    
    this.paymentsList = paymentsList;
    return this;
  }

  public IssuedDocument addPaymentsListItem(IssuedDocumentPaymentsList paymentsListItem) {
  ...
  **/
  ...
  public List<IssuedDocumentPaymentsList> getPaymentsList() {
    return paymentsList;
  }


  public void setPaymentsList(List<IssuedDocumentPaymentsList> paymentsList) {
    this.paymentsList = paymentsList;
  }
  ...
  **/
  ...
  public IssuedDocument refersTo(IssuedDocumentRefersTo refersTo) {
  ...
  **/
  ...
  public IssuedDocumentRefersTo getRefersTo() {
    return refersTo;
  }


  public void setRefersTo(IssuedDocumentRefersTo refersTo) {
    this.refersTo = refersTo;
  }
  ...
  **/
  ...
  public IssuedDocument amountCassa2(BigDecimal amountCassa2) {
  ...
  **/
  ...
  public void setAmountCassa2(BigDecimal amountCassa2) {
    this.amountCassa2 = amountCassa2;
  }
  ...
  **/
  ...
  public IssuedDocument amountWithholdingTaxTaxable(BigDecimal amountWithholdingTaxTaxable) {
   ...
   /**
   * Get amountWithholdingTaxTaxable
  ...
  **/
  ...
  public IssuedDocument amountOtherWithholdingTaxTaxable(BigDecimal amountOtherWithholdingTaxTaxable) {
   ...
   /**
   * Get amountOtherWithholdingTaxTaxable
  ...
  **/
  ...
  public IssuedDocument eiOtherWithholdingTaxCausal(String eiOtherWithholdingTaxCausal) {
   ...
   /**
   * Get eiOtherWithholdingTaxCausal
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issuedDocument.id) &&
        ...
        Objects.equals(this.refersTo, issuedDocument.refersTo) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, entity, type, number, numeration, date, currency, language, subject, visibleSubject, rcCenter, notes, rivalsa, cassa, withholdingTax, withholdingTaxTaxable, otherWithholdingTax, stampDuty, paymentMethod, useSplitPayment, useGrossPrices, eInvoice, eiData, itemsList, paymentsList, template, deliveryNoteTemplate, accInvTemplate, hMargins, showPayments, showPaymentMethod, showTotals, vMargins, showPaypalButton, showNotificationButton, deliveryNote, accompanyingInvoice, dnNumber, dnDate, dnAiPackagesNumber, dnAiWeight, dnAiCausal, dnAiDestination, dnAiTransporter, dnAiNotes, refersTo, isMarked, amountNet, amountVat, amountGross, amountRivalsa, amountCassa, amountWithholdingTax, amountOtherWithholdingTax, extraData, seenDate, nextDueDate, url, attachmentUrl, attachmentToken, eiRaw, showTspayButton, year, amountRivalsaTaxable, amountGlobalCassaTaxable, amountCassaTaxable, amountCassa2, amountCassa2Taxable, amountWithholdingTaxTaxable, amountEnasarcoTaxable, amountOtherWithholdingTaxTaxable, eiCassaType, eiCassa2Type, eiWithholdingTaxCausal, eiOtherWithholdingTaxType, eiOtherWithholdingTaxCausal, amountDueDiscount);
  }
