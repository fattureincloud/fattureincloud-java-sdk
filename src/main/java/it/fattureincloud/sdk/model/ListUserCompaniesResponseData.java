...
public class ListUserCompaniesResponseData implements Serializable {
   ...
   * @throws IOException if the JSON Object is invalid with respect to ListUserCompaniesResponseData
   */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ListUserCompaniesResponseData.openapiRequiredFields.isEmpty()) {
        return;
    ...
    if (jsonArraycompanies != null) {
      ...
      if (!jsonObj.get("companies").isJsonArray()) {
        throw new IllegalArgumentException(
            String.format(
                "Expected the field `companies` to be an array in the JSON string but got `%s`",
                jsonObj.get("companies").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ListUserCompaniesResponseData.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ListUserCompaniesResponseData' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ListUserCompaniesResponseData> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ListUserCompaniesResponseData.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ListUserCompaniesResponseData>() {
            @Override
            public void write(JsonWriter out, ListUserCompaniesResponseData value)
                throws IOException {
            ...
            @Override
            public ListUserCompaniesResponseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListUserCompaniesResponseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListUserCompaniesResponseData
   * @throws IOException if the JSON string is invalid with respect to ListUserCompaniesResponseData
   */
  public static ListUserCompaniesResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListUserCompaniesResponseData.class);
  }

  /**
   * Convert an instance of ListUserCompaniesResponseData to an JSON string
   *
   * @return JSON string
   */
