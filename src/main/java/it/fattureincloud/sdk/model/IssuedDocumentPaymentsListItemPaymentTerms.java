...
public class IssuedDocumentPaymentsListItemPaymentTerms implements Serializable {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (!IssuedDocumentPaymentsListItemPaymentTerms.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON object is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in IssuedDocumentPaymentsListItemPaymentTerms is not"
        ...
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the"
                    + " `IssuedDocumentPaymentsListItemPaymentTerms` properties. JSON: %s",
