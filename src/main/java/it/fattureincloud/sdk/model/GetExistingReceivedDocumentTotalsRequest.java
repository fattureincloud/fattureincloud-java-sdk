...
public class GetExistingReceivedDocumentTotalsRequest implements Serializable {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (!GetExistingReceivedDocumentTotalsRequest.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON object is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetExistingReceivedDocumentTotalsRequest is not found"
        ...
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the"
                    + " `GetExistingReceivedDocumentTotalsRequest` properties. JSON: %s",
