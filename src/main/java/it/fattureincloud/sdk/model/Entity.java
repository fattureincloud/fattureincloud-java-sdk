...
public class Entity implements Serializable {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (!Entity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    if ((jsonObj.get("country_iso") != null && !jsonObj.get("country_iso").isJsonNull())
      ...
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `country_iso` to be a primitive type in the JSON string but got"
                  + " `%s`",
