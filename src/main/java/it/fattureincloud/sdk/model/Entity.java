...
public class Entity {
  ...
  public Entity intentDeclarationProtocolNumber(LocalDate intentDeclarationProtocolNumber) {
  ...
  public Entity intentDeclarationProtocolDate(String intentDeclarationProtocolDate) {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    for (Entry<String, JsonElement> entry : entries) {
      if (!Entity.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `Entity` properties. JSON:"
                    + " %s",
    ...
    if (jsonObj.get("contact_person") != null && !jsonObj.get("contact_person").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("vat_number") != null && !jsonObj.get("vat_number").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("address_street") != null && !jsonObj.get("address_street").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("address_city") != null && !jsonObj.get("address_city").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("address_province") != null
    ...
    if (jsonObj.get("address_extra") != null && !jsonObj.get("address_extra").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("certified_email") != null
    ...
    if (jsonObj.getAsJsonObject("default_payment_method") != null) {
    ...
    if (jsonObj.get("bank_iban") != null && !jsonObj.get("bank_iban").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.get("bank_swift_code") != null
        && !jsonObj.get("bank_swift_code").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `bank_swift_code` to be a primitive type in the JSON string but"
                  + " got `%s`",
              jsonObj.get("bank_swift_code").toString()));
    }
    if (jsonObj.get("shipping_address") != null
        && !jsonObj.get("shipping_address").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `shipping_address` to be a primitive type in the JSON string but"
                  + " got `%s`",
              jsonObj.get("shipping_address").toString()));
    }
    if (jsonObj.get("ei_code") != null && !jsonObj.get("ei_code").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `ei_code` to be a primitive type in the JSON string but got `%s`",
              jsonObj.get("ei_code").toString()));
    }
    if (jsonObj.get("intent_declaration_protocol_date") != null
        && !jsonObj.get("intent_declaration_protocol_date").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
              "Expected the field `intent_declaration_protocol_date` to be a primitive type in the"
                  + " JSON string but got `%s`",
              jsonObj.get("intent_declaration_protocol_date").toString()));
    }
