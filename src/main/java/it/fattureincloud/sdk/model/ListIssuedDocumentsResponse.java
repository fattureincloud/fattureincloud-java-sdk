...
public class ListIssuedDocumentsResponse {
   ...
   * @throws IOException if the JSON Object is invalid with respect to ListIssuedDocumentsResponse
   */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ListIssuedDocumentsResponse.openapiRequiredFields.isEmpty()) {
        return;
      } else { // has required fields
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ListIssuedDocumentsResponse is not found in the empty JSON string",
                ListIssuedDocumentsResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Entry<String, JsonElement> entry : entries) {
      if (!ListIssuedDocumentsResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ListIssuedDocumentsResponse` properties. JSON: %s",
    ...
    if (jsonArraydata != null) {
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        IssuedDocument.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      }
      ;
    }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ListIssuedDocumentsResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ListIssuedDocumentsResponse' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ListIssuedDocumentsResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ListIssuedDocumentsResponse.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ListIssuedDocumentsResponse>() {
            @Override
            public void write(JsonWriter out, ListIssuedDocumentsResponse value)
                throws IOException {
            ...
            @Override
            public ListIssuedDocumentsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListIssuedDocumentsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListIssuedDocumentsResponse
   * @throws IOException if the JSON string is invalid with respect to ListIssuedDocumentsResponse
   */
  public static ListIssuedDocumentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListIssuedDocumentsResponse.class);
  }

  /**
   * Convert an instance of ListIssuedDocumentsResponse to an JSON string
   *
   * @return JSON string
   */
