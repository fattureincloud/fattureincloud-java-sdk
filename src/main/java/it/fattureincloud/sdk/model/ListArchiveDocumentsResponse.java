...
public class ListArchiveDocumentsResponse {
   ...
   * @throws IOException if the JSON Object is invalid with respect to ListArchiveDocumentsResponse
   */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ListArchiveDocumentsResponse.openapiRequiredFields.isEmpty()) {
        return;
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ListArchiveDocumentsResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ListArchiveDocumentsResponse' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ListArchiveDocumentsResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ListArchiveDocumentsResponse.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ListArchiveDocumentsResponse>() {
            @Override
            public void write(JsonWriter out, ListArchiveDocumentsResponse value)
                throws IOException {
            ...
            @Override
            public ListArchiveDocumentsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListArchiveDocumentsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListArchiveDocumentsResponse
   * @throws IOException if the JSON string is invalid with respect to ListArchiveDocumentsResponse
   */
  public static ListArchiveDocumentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListArchiveDocumentsResponse.class);
  }

  /**
   * Convert an instance of ListArchiveDocumentsResponse to an JSON string
   *
   * @return JSON string
   */
