...
public class EmailSchedule implements Serializable {
  ...
  public EmailSchedule senderId(BigDecimal senderId) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "One or more comma separated recipient emails")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If set to true, documents will be sent as PDF attachments too")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If set to true, a copy of the email will be sent to the `cc_email` specified by `Get email data`")
