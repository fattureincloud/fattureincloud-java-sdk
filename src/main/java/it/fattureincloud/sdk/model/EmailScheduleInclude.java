...
public class EmailScheduleInclude implements Serializable {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "If set to true, the email will have a button to view the document")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If set to true, the email will have a button to view the delivery note")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If set to true, the email will have a button to view the attachment")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If set to true, the email will have a button to view the accompanying invoice")
