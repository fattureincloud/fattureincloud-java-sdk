...
public class ListSuppliersResponse {
   ...
   * @throws IOException if the JSON Object is invalid with respect to ListSuppliersResponse
   */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ListSuppliersResponse.openapiRequiredFields.isEmpty()) {
        return;
      } else { // has required fields
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in ListSuppliersResponse is not found in the empty JSON string",
                ListSuppliersResponse.openapiRequiredFields.toString()));
      }
    }
    ...
    for (Entry<String, JsonElement> entry : entries) {
      if (!ListSuppliersResponse.openapiFields.contains(entry.getKey())) {
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the `ListSuppliersResponse` properties. JSON: %s",
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ListSuppliersResponse.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ListSuppliersResponse' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ListSuppliersResponse> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ListSuppliersResponse.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ListSuppliersResponse>() {
            @Override
            public void write(JsonWriter out, ListSuppliersResponse value) throws IOException {
              JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
              elementAdapter.write(out, obj);
            }

            @Override
            public ListSuppliersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListSuppliersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListSuppliersResponse
   * @throws IOException if the JSON string is invalid with respect to ListSuppliersResponse
   */
  public static ListSuppliersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListSuppliersResponse.class);
  }

  /**
   * Convert an instance of ListSuppliersResponse to an JSON string
   *
   * @return JSON string
   */
