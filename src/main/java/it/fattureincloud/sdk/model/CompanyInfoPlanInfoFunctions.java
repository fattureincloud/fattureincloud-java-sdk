...
public class CompanyInfoPlanInfoFunctions {
    ...
    if (jsonObj == null) {
      if (CompanyInfoPlanInfoFunctions.openapiRequiredFields.isEmpty()) {
        ...
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in CompanyInfoPlanInfoFunctions is not found in the empty"
                    + " JSON string",
        ...
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the"
                    + " `CompanyInfoPlanInfoFunctions` properties. JSON: %s",
