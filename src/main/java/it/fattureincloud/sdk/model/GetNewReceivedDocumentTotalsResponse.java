...
public class GetNewReceivedDocumentTotalsResponse {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (GetNewReceivedDocumentTotalsResponse.openapiRequiredFields.isEmpty()) {
        return;
      } else { // has required fields
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in GetNewReceivedDocumentTotalsResponse is not found in"
        ...
        throw new IllegalArgumentException(
            String.format(
                "The field `%s` in the JSON string is not defined in the"
                    + " `GetNewReceivedDocumentTotalsResponse` properties. JSON: %s",
