...
public class VerifyEInvoiceXmlErrorResponseError implements Serializable {
  ...
  private VerifyEInvoiceXmlErrorResponseErrorValidationResult validationResult;
  ...
  public VerifyEInvoiceXmlErrorResponseError validationResult(
      VerifyEInvoiceXmlErrorResponseErrorValidationResult validationResult) {
   ...
   */
  @javax.annotation.Nullable
  public VerifyEInvoiceXmlErrorResponseErrorValidationResult getValidationResult() {
    return validationResult;
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (!VerifyEInvoiceXmlErrorResponseError.openapiRequiredFields
    ...
    if (jsonObj.get("validation_result") != null
        && !jsonObj.get("validation_result").isJsonNull()) {
      VerifyEInvoiceXmlErrorResponseErrorValidationResult.validateJsonObject(
          jsonObj.getAsJsonObject("validation_result"));
    }
  }
