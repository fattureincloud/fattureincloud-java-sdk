...
public class CashbookEntry {
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (jsonObj.get("entity_name") != null && !jsonObj.get("entity_name").isJsonPrimitive()) {
      throw new IllegalArgumentException(
          String.format(
    ...
    if (jsonObj.getAsJsonObject("payment_account_in") != null) {
    ...
    if (jsonObj.getAsJsonObject("payment_account_out") != null) {
