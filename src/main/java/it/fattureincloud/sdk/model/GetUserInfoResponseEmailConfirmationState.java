...
public class GetUserInfoResponseEmailConfirmationState {
  ...
  static {
    ...
    openapiFields.add("need_confirmation");
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (GetUserInfoResponseEmailConfirmationState.openapiRequiredFields.isEmpty()) {
        return;
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      final TypeAdapter<GetUserInfoResponseEmailConfirmationState> thisAdapter =
          gson.getDelegateAdapter(
              this, TypeToken.get(GetUserInfoResponseEmailConfirmationState.class));

      return (TypeAdapter<T>)
          new TypeAdapter<GetUserInfoResponseEmailConfirmationState>() {
            @Override
            public void write(JsonWriter out, GetUserInfoResponseEmailConfirmationState value)
                throws IOException {
            ...
            @Override
            public GetUserInfoResponseEmailConfirmationState read(JsonReader in)
                throws IOException {
  ...
  /**
   * Create an instance of GetUserInfoResponseEmailConfirmationState given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUserInfoResponseEmailConfirmationState
   * @throws IOException if the JSON string is invalid with respect to
   *     GetUserInfoResponseEmailConfirmationState
   */
  public static GetUserInfoResponseEmailConfirmationState fromJson(String jsonString)
      throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUserInfoResponseEmailConfirmationState.class);
  }

  /**
   * Convert an instance of GetUserInfoResponseEmailConfirmationState to an JSON string
   *
   * @return JSON string
   */
