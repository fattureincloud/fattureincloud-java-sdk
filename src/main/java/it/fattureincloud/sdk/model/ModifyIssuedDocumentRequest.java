...
public class ModifyIssuedDocumentRequest {
   ...
   * @throws IOException if the JSON Object is invalid with respect to ModifyIssuedDocumentRequest
   */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    if (jsonObj == null) {
      if (ModifyIssuedDocumentRequest.openapiRequiredFields.isEmpty()) {
        return;
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      if (!ModifyIssuedDocumentRequest.class.isAssignableFrom(type.getRawType())) {
        return null; // this class only serializes 'ModifyIssuedDocumentRequest' and its subtypes
      }
      final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
      final TypeAdapter<ModifyIssuedDocumentRequest> thisAdapter =
          gson.getDelegateAdapter(this, TypeToken.get(ModifyIssuedDocumentRequest.class));

      return (TypeAdapter<T>)
          new TypeAdapter<ModifyIssuedDocumentRequest>() {
            @Override
            public void write(JsonWriter out, ModifyIssuedDocumentRequest value)
                throws IOException {
            ...
            @Override
            public ModifyIssuedDocumentRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyIssuedDocumentRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyIssuedDocumentRequest
   * @throws IOException if the JSON string is invalid with respect to ModifyIssuedDocumentRequest
   */
  public static ModifyIssuedDocumentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyIssuedDocumentRequest.class);
  }

  /**
   * Convert an instance of ModifyIssuedDocumentRequest to an JSON string
   *
   * @return JSON string
   */
