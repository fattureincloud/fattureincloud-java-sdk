...
import it.fattureincloud.sdk.model.GetTemplatesResponse;
...
public class SettingsApi {
   ...
   *
   * @param companyId The ID of the company. (required)
   * @param templateId The Referred Template Id. (required)
   * @param fields List of comma-separated fields. (optional)
   * @param fieldset Name of the fieldset. (optional)
   * @param _callback Callback for upload/download progress
   * @return Call to execute
   ...
   * </table>
   */
  public okhttp3.Call getTemplateCall(
      Integer companyId,
      Integer templateId,
      String fields,
      String fieldset,
    ...
    String localVarPath =
        "/c/{company_id}/settings/templates/{template_id}"
            .replace("{" + "company_id" + "}", localVarApiClient.escapeString(companyId.toString()))
            .replace(
                "{" + "template_id" + "}", localVarApiClient.escapeString(templateId.toString()));
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getTemplateValidateBeforeCall(
      Integer companyId,
      Integer templateId,
      String fields,
      String fieldset,
    ...
    if (companyId == null) {
      throw new ApiException(
          "Missing the required parameter 'companyId' when calling getTemplate(Async)");
    }

    // verify the required parameter 'templateId' is set
    if (templateId == null) {
      throw new ApiException(
          "Missing the required parameter 'templateId' when calling getTemplate(Async)");
    }

    return getTemplateCall(companyId, templateId, fields, fieldset, _callback);
  }
   ...
   * </table>
   */
  public GetTemplatesResponse getTemplate(
      Integer companyId, Integer templateId, String fields, String fieldset) throws ApiException {
    ApiResponse<GetTemplatesResponse> localVarResp =
        getTemplateWithHttpInfo(companyId, templateId, fields, fieldset);
    return localVarResp.getData();
  }
   ...
   * </table>
   */
  public ApiResponse<GetTemplatesResponse> getTemplateWithHttpInfo(
      Integer companyId, Integer templateId, String fields, String fieldset) throws ApiException {
    okhttp3.Call localVarCall =
        getTemplateValidateBeforeCall(companyId, templateId, fields, fieldset, null);
    Type localVarReturnType = new TypeToken<GetTemplatesResponse>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }

  /**
   * Get Template (asynchronously) Gets a specified template.
   *
   * @param companyId The ID of the company. (required)
   * @param templateId The Referred Template Id. (required)
   * @param fields List of comma-separated fields. (optional)
   ...
   * </table>
   */
  public okhttp3.Call getTemplateAsync(
      Integer companyId,
      Integer templateId,
      String fields,
      String fieldset,
      final ApiCallback<GetTemplatesResponse> _callback)
      throws ApiException {

    okhttp3.Call localVarCall =
        getTemplateValidateBeforeCall(companyId, templateId, fields, fieldset, _callback);
    Type localVarReturnType = new TypeToken<GetTemplatesResponse>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public okhttp3.Call listTemplatesCall(
      Integer companyId, String fields, String fieldset, final ApiCallback _callback)
      throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
  ...
  private okhttp3.Call listTemplatesValidateBeforeCall(
    ...
    if (companyId == null) {
      throw new ApiException(
          "Missing the required parameter 'companyId' when calling listTemplates(Async)");
    }

    return listTemplatesCall(companyId, fields, fieldset, _callback);
  }
   ...
   * </table>
   */
  public ListTemplatesResponse listTemplates(Integer companyId, String fields, String fieldset)
      throws ApiException {
    ApiResponse<ListTemplatesResponse> localVarResp =
        listTemplatesWithHttpInfo(companyId, fields, fieldset);
    return localVarResp.getData();
  }
   ...
   * </table>
   */
  public ApiResponse<ListTemplatesResponse> listTemplatesWithHttpInfo(
      Integer companyId, String fields, String fieldset) throws ApiException {
    okhttp3.Call localVarCall = listTemplatesValidateBeforeCall(companyId, fields, fieldset, null);
    Type localVarReturnType = new TypeToken<ListTemplatesResponse>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }

  /**
   * List Templates (asynchronously) Gets all the standard and private templates.
   *
   * @param companyId The ID of the company. (required)
   * @param fields List of comma-separated fields. (optional)
   * @param fieldset Name of the fieldset. (optional)
  ...
  public okhttp3.Call listTemplatesAsync(
    ...
    okhttp3.Call localVarCall =
        listTemplatesValidateBeforeCall(companyId, fields, fieldset, _callback);
    Type localVarReturnType = new TypeToken<ListTemplatesResponse>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
