...
public class ArchiveApi {
     ...
     */
    public okhttp3.Call listArchiveDocumentsCall(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listArchiveDocumentsValidateBeforeCall(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listArchiveDocumentsCall(companyId, fields, fieldset, sort, page, perPage, _callback);
        return localVarCall;
     ...
     */
    public ListArchiveDocumentsResponse listArchiveDocuments(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        ApiResponse<ListArchiveDocumentsResponse> localVarResp = listArchiveDocumentsWithHttpInfo(companyId, fields, fieldset, sort, page, perPage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListArchiveDocumentsResponse> listArchiveDocumentsWithHttpInfo(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = listArchiveDocumentsValidateBeforeCall(companyId, fields, fieldset, sort, page, perPage, null);
     ...
     */
    public okhttp3.Call listArchiveDocumentsAsync(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback<ListArchiveDocumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listArchiveDocumentsValidateBeforeCall(companyId, fields, fieldset, sort, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<ListArchiveDocumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
