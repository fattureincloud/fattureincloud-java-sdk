...
public class ReceivedDocumentsApi {
     ...
     */
    public okhttp3.Call listReceivedDocumentsCall(Integer companyId, String type, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listReceivedDocumentsValidateBeforeCall(Integer companyId, String type, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listReceivedDocumentsCall(companyId, type, fields, fieldset, sort, page, perPage, _callback);
        return localVarCall;
     ...
     */
    public ListReceivedDocumentsResponse listReceivedDocuments(Integer companyId, String type, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        ApiResponse<ListReceivedDocumentsResponse> localVarResp = listReceivedDocumentsWithHttpInfo(companyId, type, fields, fieldset, sort, page, perPage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListReceivedDocumentsResponse> listReceivedDocumentsWithHttpInfo(Integer companyId, String type, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = listReceivedDocumentsValidateBeforeCall(companyId, type, fields, fieldset, sort, page, perPage, null);
     ...
     */
    public okhttp3.Call listReceivedDocumentsAsync(Integer companyId, String type, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback<ListReceivedDocumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listReceivedDocumentsValidateBeforeCall(companyId, type, fields, fieldset, sort, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<ListReceivedDocumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
