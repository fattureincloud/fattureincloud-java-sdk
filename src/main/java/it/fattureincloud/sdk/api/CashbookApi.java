...
public class CashbookApi {
   ...
   * <tr><td> 200 </td><td> The created Cashbook Entry. </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
  ...
  private okhttp3.Call createCashbookEntryValidateBeforeCall(
    ...
    return createCashbookEntryCall(companyId, createCashbookEntryRequest, _callback);
  }
  ...
  private okhttp3.Call deleteCashbookEntryValidateBeforeCall(
    ...
    return deleteCashbookEntryCall(companyId, documentId, _callback);
  }
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> Cashbook Entry. </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
  ...
  private okhttp3.Call getCashbookEntryValidateBeforeCall(
    ...
    return getCashbookEntryCall(companyId, documentId, fields, fieldset, _callback);
  }
  ...
  private okhttp3.Call listCashbookEntriesValidateBeforeCall(
    ...
    return listCashbookEntriesCall(
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> The modified Cashbook Entry </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
  ...
  private okhttp3.Call modifyCashbookEntryValidateBeforeCall(
    ...
    return modifyCashbookEntryCall(companyId, documentId, modifyCashbookEntryRequest, _callback);
  }
