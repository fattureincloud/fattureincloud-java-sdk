...
public class IssuedEInvoicesApi {
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td>  </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
  ...
  public okhttp3.Call getEInvoiceXmlCall(
    ...
    final String[] localVarAccepts = {"text/xml", "application/json"};
    final String localVarAccept = localVarApiClient.selectHeaderAccept(localVarAccepts);
    if (localVarAccept != null) {
      localVarHeaderParams.put("Accept", localVarAccept);
    }
  ...
  private okhttp3.Call getEInvoiceXmlValidateBeforeCall(
    ...
    return getEInvoiceXmlCall(companyId, documentId, includeAttachment, _callback);
  }
  ...
  private okhttp3.Call sendEInvoiceValidateBeforeCall(
    ...
    return sendEInvoiceCall(companyId, documentId, sendEInvoiceRequest, _callback);
  }
   ...
   * <tr><td> 405 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 409 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 422 </td><td> Example response </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 429 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 500 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * </table>
   */
  ...
  private okhttp3.Call verifyEInvoiceXmlValidateBeforeCall(
    ...
    return verifyEInvoiceXmlCall(companyId, documentId, _callback);
  }
