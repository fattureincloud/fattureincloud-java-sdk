...
public class SuppliersApi {
     ...
     */
    public okhttp3.Call listSuppliersCall(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listSuppliersValidateBeforeCall(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listSuppliersCall(companyId, fields, fieldset, sort, page, perPage, _callback);
        return localVarCall;
     ...
     */
    public ListSuppliersResponse listSuppliers(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        ApiResponse<ListSuppliersResponse> localVarResp = listSuppliersWithHttpInfo(companyId, fields, fieldset, sort, page, perPage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListSuppliersResponse> listSuppliersWithHttpInfo(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = listSuppliersValidateBeforeCall(companyId, fields, fieldset, sort, page, perPage, null);
     ...
     */
    public okhttp3.Call listSuppliersAsync(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback<ListSuppliersResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listSuppliersValidateBeforeCall(companyId, fields, fieldset, sort, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<ListSuppliersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
