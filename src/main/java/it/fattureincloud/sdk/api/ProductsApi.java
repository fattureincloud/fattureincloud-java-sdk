...
public class ProductsApi {
  ...
  private okhttp3.Call createProductValidateBeforeCall(
    ...
    return createProductCall(companyId, createProductRequest, _callback);
  }
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> Product removed. </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
  ...
  private okhttp3.Call deleteProductValidateBeforeCall(
    ...
    return deleteProductCall(companyId, productId, _callback);
  }
  ...
  private okhttp3.Call getProductValidateBeforeCall(
    ...
    return getProductCall(companyId, productId, fields, fieldset, _callback);
  }
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> Products List. </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
  ...
  private okhttp3.Call listProductsValidateBeforeCall(
    ...
    return listProductsCall(companyId, fields, fieldset, sort, page, perPage, q, _callback);
  }
  ...
  private okhttp3.Call modifyProductValidateBeforeCall(
    ...
    return modifyProductCall(companyId, productId, modifyProductRequest, _callback);
  }
