...
import it.fattureincloud.sdk.model.GetEntityClientPreCreateInfoResponse;
...
public class ClientsApi {
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> Entity Removed </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> Client Details. </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   ...
   * </table>
   */
  public okhttp3.Call getClientInfoCall(Integer companyId, final ApiCallback _callback)
      throws ApiException {
    String basePath = null;
    // Operation Servers
    String[] localBasePaths = new String[] {};
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call getClientInfoValidateBeforeCall(
      Integer companyId, final ApiCallback _callback) throws ApiException {
    // verify the required parameter 'companyId' is set
    if (companyId == null) {
      throw new ApiException(
          "Missing the required parameter 'companyId' when calling getClientInfo(Async)");
    }

    return getClientInfoCall(companyId, _callback);
  }
   ...
   * </table>
   */
  public GetEntityClientPreCreateInfoResponse getClientInfo(Integer companyId) throws ApiException {
    ApiResponse<GetEntityClientPreCreateInfoResponse> localVarResp =
        getClientInfoWithHttpInfo(companyId);
    return localVarResp.getData();
  }
   ...
   *
   * @param companyId The ID of the company. (required)
   * @return ApiResponse&lt;GetEntityClientPreCreateInfoResponse&gt;
   * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the
   *     response body
   * @http.response.details
   *     <table border="1">
   ...
   * </table>
   */
  public ApiResponse<GetEntityClientPreCreateInfoResponse> getClientInfoWithHttpInfo(
      Integer companyId) throws ApiException {
    okhttp3.Call localVarCall = getClientInfoValidateBeforeCall(companyId, null);
    Type localVarReturnType = new TypeToken<GetEntityClientPreCreateInfoResponse>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }

  /**
   * Get Client info (asynchronously) Retrieves the information useful while creating a new Client.
   *
   * @param companyId The ID of the company. (required)
   * @param _callback The callback to be executed when the API call finishes
   * @return The request call
   ...
   * </table>
   */
  public okhttp3.Call getClientInfoAsync(
      Integer companyId, final ApiCallback<GetEntityClientPreCreateInfoResponse> _callback)
      throws ApiException {

    okhttp3.Call localVarCall = getClientInfoValidateBeforeCall(companyId, _callback);
    Type localVarReturnType = new TypeToken<GetEntityClientPreCreateInfoResponse>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
   ...
   * <caption>Response Details</caption>
   * <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   * <tr><td> 200 </td><td> Client modified. </td><td>  * RateLimit-HourlyRemaining -  <br>  * RateLimit-HourlyLimit -  <br>  * RateLimit-MonthlyRemaining -  <br>  * RateLimit-MonthlyLimit -  <br>  </td></tr>
   * <tr><td> 400 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 401 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 403 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
   * <tr><td> 404 </td><td> ErrorResponse </td><td>  * Retry-After -  <br>  </td></tr>
