...
public class ClientsApi {
     ...
     */
    public okhttp3.Call listClientsCall(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listClientsValidateBeforeCall(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listClientsCall(companyId, fields, fieldset, sort, page, perPage, _callback);
        return localVarCall;
     ...
     */
    public ListClientsResponse listClients(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        ApiResponse<ListClientsResponse> localVarResp = listClientsWithHttpInfo(companyId, fields, fieldset, sort, page, perPage);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListClientsResponse> listClientsWithHttpInfo(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage) throws ApiException {
        okhttp3.Call localVarCall = listClientsValidateBeforeCall(companyId, fields, fieldset, sort, page, perPage, null);
     ...
     */
    public okhttp3.Call listClientsAsync(Integer companyId, String fields, String fieldset, String sort, Integer page, Integer perPage, final ApiCallback<ListClientsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listClientsValidateBeforeCall(companyId, fields, fieldset, sort, page, perPage, _callback);
        Type localVarReturnType = new TypeToken<ListClientsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
