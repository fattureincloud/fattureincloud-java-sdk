...
import it.fattureincloud.sdk.model.VerifyWebhooksSubscriptionRequest;
...
public class WebhooksApi {
  ...
  /**
   * Build call for verifyWebhooksSubscription
   *
   * @param companyId The ID of the company. (required)
   * @param subscriptionId The ID of the subscription. (required)
   * @param verifyWebhooksSubscriptionRequest (optional)
   * @param _callback Callback for upload/download progress
   * @return Call to execute
   * @throws ApiException If fail to serialize the request body object
   * @http.response.details
   ...
   * </table>
   */
  public okhttp3.Call verifyWebhooksSubscriptionCall(
      Integer companyId,
      String subscriptionId,
    ...
    Object localVarPostBody = verifyWebhooksSubscriptionRequest;
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call verifyWebhooksSubscriptionValidateBeforeCall(
      Integer companyId,
      String subscriptionId,
      VerifyWebhooksSubscriptionRequest verifyWebhooksSubscriptionRequest,
      final ApiCallback _callback)
    ...
    if (companyId == null) {
      throw new ApiException(
          "Missing the required parameter 'companyId' when calling verifyWebhooksSubscription(Async)");
    }

    // verify the required parameter 'subscriptionId' is set
    if (subscriptionId == null) {
      throw new ApiException(
          "Missing the required parameter 'subscriptionId' when calling verifyWebhooksSubscription(Async)");
    }

    return verifyWebhooksSubscriptionCall(
        companyId, subscriptionId, verifyWebhooksSubscriptionRequest, _callback);
  }
   ...
   * </table>
   */
  public void verifyWebhooksSubscription(
      Integer companyId,
      String subscriptionId,
      VerifyWebhooksSubscriptionRequest verifyWebhooksSubscriptionRequest)
      throws ApiException {
    verifyWebhooksSubscriptionWithHttpInfo(
        companyId, subscriptionId, verifyWebhooksSubscriptionRequest);
  }
   ...
   * </table>
   */
  public ApiResponse<Void> verifyWebhooksSubscriptionWithHttpInfo(
      Integer companyId,
      String subscriptionId,
      VerifyWebhooksSubscriptionRequest verifyWebhooksSubscriptionRequest)
      throws ApiException {
    okhttp3.Call localVarCall =
        verifyWebhooksSubscriptionValidateBeforeCall(
            companyId, subscriptionId, verifyWebhooksSubscriptionRequest, null);
    return localVarApiClient.execute(localVarCall);
  }

  /**
   * Verify Webhooks Subscription (asynchronously) Verify a webhook subscription.
   *
   * @param companyId The ID of the company. (required)
   * @param subscriptionId The ID of the subscription. (required)
   * @param verifyWebhooksSubscriptionRequest (optional)
   ...
   * </table>
   */
  public okhttp3.Call verifyWebhooksSubscriptionAsync(
      Integer companyId,
      String subscriptionId,
      VerifyWebhooksSubscriptionRequest verifyWebhooksSubscriptionRequest,
