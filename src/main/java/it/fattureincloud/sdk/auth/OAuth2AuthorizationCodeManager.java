...
public class OAuth2AuthorizationCodeManager {
  ...
  public Either<OAuth2AuthorizationCodeError, OAuth2AuthorizationCodeResponse> fetchToken(
  ...
  public Either<OAuth2AuthorizationCodeError, OAuth2AuthorizationCodeResponse> refreshToken(
  ...
  private Either<OAuth2AuthorizationCodeError, OAuth2AuthorizationCodeResponse> post(
      String url, String json) throws IOException {
    ...
    try (Response response = this.httpClient.newCall(request).execute()) {
      ...
      if (code != 200) {
        OAuth2AuthorizationCodeError err =
            gson.fromJson(responseBody, OAuth2AuthorizationCodeError.class);
        err.setCode(code);
        return Either.left(err);
      } else {
        OAuth2AuthorizationCodeResponse oauthRes =
            gson.fromJson(responseBody, OAuth2AuthorizationCodeResponse.class);
