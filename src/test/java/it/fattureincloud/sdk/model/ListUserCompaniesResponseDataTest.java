...
public class ListUserCompaniesResponseDataTest {
  ...
  public void testListUserCompaniesResponseData() {
    ListUserCompaniesResponseData rd =
    ...
    String str =
        "{\"companies\":[{\"id\":12345,\"name\":\"Studio"
    ...
    ListUserCompaniesResponseData generated =
        gson.fromJson(str, ListUserCompaniesResponseData.class);
  ...
  public void companiesTest() {
    ...
    ListUserCompaniesResponseData expected =
        new ListUserCompaniesResponseData().companies(new ArrayList<>());
