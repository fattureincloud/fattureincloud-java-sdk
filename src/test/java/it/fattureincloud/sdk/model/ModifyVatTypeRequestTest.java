...
public class ModifyVatTypeRequestTest {
    private ModifyVatTypeRequest model;

    @BeforeEach
    public void init() {
        model = new ModifyVatTypeRequest()
                .data(
                        new VatType()
                                .id(12345)
    ...
    public void testModifyVatTypeRequest() {
        ...
        ModifyVatTypeRequest generated = gson.fromJson(str, ModifyVatTypeRequest.class);
    ...
    public void dataTest() {
        ...
        ModifyVatTypeRequest actual = new ModifyVatTypeRequest();
