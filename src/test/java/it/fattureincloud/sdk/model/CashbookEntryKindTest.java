...
public class CashbookEntryKindTest {
  ...
  public void testCashbookEntryKind() {
    ...
    assertEquals(
        CashbookEntryKind.CASHBOOK, gson.fromJson("\"cashbook\"", CashbookEntryKind.class));
    assertEquals(
        CashbookEntryKind.ISSUED_DOCUMENT,
        gson.fromJson("\"issued_document\"", CashbookEntryKind.class));
    assertEquals(
        CashbookEntryKind.RECEIVED_DOCUMENT,
        gson.fromJson("\"received_document\"", CashbookEntryKind.class));
    ...
    assertEquals(
        CashbookEntryKind.RECEIVED_DOCUMENT, CashbookEntryKind.fromValue("received_document"));
