...
public class EntityTest {
  ...
  public void testEntity() {
    ...
    String str =
        "{\"id\":16451,\"code\":\"AE86\",\"name\":\"Avv. Maria"
            ...
            + " Roma,"
            + " 1\",\"address_postal_code\":\"20900\",\"address_city\":\"Milano\",\"address_province\":\"MI\",\"address_extra\":\"\",\"country\":\"Italia\",\"email\":\"maria.rossi@example.com\",\"certified_email\":\"maria.rossi@pec.example.com\",\"phone\":\"1234567890\",\"fax\":\"\",\"notes\":\"\",\"default_payment_terms\":1,\"default_vat\":{\"id\":54321,\"value\":45,\"description\":\"\",\"is_disabled\":false},\"default_payment_terms_type\":\"standard\",\"default_payment_method\":{\"id\":386092,\"name\":\"Credit"
  ...
  public void defaultVatTest() {
    VatType vt1 =
        new VatType().id(54321).value(BigDecimal.valueOf(45)).description("aaa").isDisabled(false);

    VatType vt2 =
        new VatType().id(88888).value(BigDecimal.valueOf(55)).description("bbb").isDisabled(true);
  ...
  public void defaultPaymentMethodTest() {
    PaymentMethod pm1 = new PaymentMethod().id(54321).name("Credit card");

    PaymentMethod pm2 = new PaymentMethod().id(88888).name("Assegno");
