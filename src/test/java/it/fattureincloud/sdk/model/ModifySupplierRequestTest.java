...
public class ModifySupplierRequestTest {
    private ModifySupplierRequest model;

    @BeforeEach
    public void init() {
        model = new ModifySupplierRequest()
                .data(
                        new Supplier()
                                .id(12345)
                                .code("AE86")
    ...
    public void testModifySupplierRequest() {
        ...
        ModifySupplierRequest generated = gson.fromJson(str, ModifySupplierRequest.class);
    ...
    public void dataTest() {
        ...
        ModifySupplierRequest actual = new ModifySupplierRequest();
