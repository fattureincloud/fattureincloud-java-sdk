...
public class IssuedDocumentTypeTest {
  ...
  public void testIssuedDocumentType() {
    ...
    assertEquals(
        IssuedDocumentType.CREDIT_NOTE, gson.fromJson("\"credit_note\"", IssuedDocumentType.class));
    assertEquals(
        IssuedDocumentType.DELIVERY_NOTE,
        gson.fromJson("\"delivery_note\"", IssuedDocumentType.class));
    assertEquals(
        IssuedDocumentType.INVOICE, gson.fromJson("\"invoice\"", IssuedDocumentType.class));
    assertEquals(IssuedDocumentType.ORDER, gson.fromJson("\"order\"", IssuedDocumentType.class));
    assertEquals(
        IssuedDocumentType.PROFORMA, gson.fromJson("\"proforma\"", IssuedDocumentType.class));
    assertEquals(IssuedDocumentType.QUOTE, gson.fromJson("\"quote\"", IssuedDocumentType.class));
    assertEquals(
        IssuedDocumentType.RECEIPT, gson.fromJson("\"receipt\"", IssuedDocumentType.class));
    assertEquals(
        IssuedDocumentType.SUPPLIER_ORDER,
        gson.fromJson("\"supplier_order\"", IssuedDocumentType.class));
    assertEquals(
        IssuedDocumentType.WORK_REPORT, gson.fromJson("\"work_report\"", IssuedDocumentType.class));
