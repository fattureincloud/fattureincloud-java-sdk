...
public class CreateSupplierResponseTest {
    private CreateSupplierResponse model;

    @BeforeEach
    public void init() {
        model = new CreateSupplierResponse()
                .data(
                        new Supplier()
                                .id(12345)
                                .code("AE86")
    ...
    public void testCreateSupplierResponse() {
        ...
        CreateSupplierResponse generated = gson.fromJson(str, CreateSupplierResponse.class);
    ...
    public void dataTest() {
        ...
        CreateSupplierResponse actual = new CreateSupplierResponse();
