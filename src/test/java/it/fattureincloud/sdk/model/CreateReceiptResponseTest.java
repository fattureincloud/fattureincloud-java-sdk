...
public class CreateReceiptResponseTest {
    private CreateReceiptResponse model;

    @BeforeEach
    public void init() {
        model = new CreateReceiptResponse()
                .data(
                        new Receipt()
                                .id(12345)
    ...
    public void testCreateReceiptResponse() {
        ...
        CreateReceiptResponse generated = gson.fromJson(str, CreateReceiptResponse.class);
    ...
    public void dataTest() {
        ...
        CreateReceiptResponse actual = new CreateReceiptResponse();
