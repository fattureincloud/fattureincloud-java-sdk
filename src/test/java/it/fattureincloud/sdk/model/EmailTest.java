...
public class EmailTest {
  ...
  public void testEmail() {
    ...
    String str =
        "{\"id\":1,\"status\":\"sent\",\"sent_date\":\"2022-07-17T13:53:12Z\",\"errors_count\":0,\"error_log\":\"\",\"from_email\":\"test@mail.it\",\"from_name\":\"Test"
  ...
  public void recipientDateTest() {
    assertEquals(
        OffsetDateTime.of(LocalDateTime.of(2022, 7, 17, 13, 53, 12), ZoneOffset.UTC),
        model.getRecipientDate());
    model.setRecipientDate(
        OffsetDateTime.of(LocalDateTime.of(2023, 7, 17, 13, 53, 12), ZoneOffset.UTC));
    assertEquals(
        OffsetDateTime.of(LocalDateTime.of(2023, 7, 17, 13, 53, 12), ZoneOffset.UTC),
        model.getRecipientDate());
  ...
  public void attachmentsTest() {
    EmailAttachment ea = new EmailAttachment().filename("failneim").url("www.joshua.cat");
    ...
    List<EmailAttachment> e2 =
        Arrays.asList(ea, new EmailAttachment().filename("failneim2").url("www.joshua.dog"));
