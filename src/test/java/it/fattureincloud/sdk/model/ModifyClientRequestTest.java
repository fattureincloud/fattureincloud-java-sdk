...
public class ModifyClientRequestTest {
    private ModifyClientRequest model;

    @BeforeEach
    public void init() {
        model = new ModifyClientRequest()
                .data(
                        new Client()
                                .id(12345)
                                .code("AE86")
    ...
    public void testModifyClientRequest() {
        ...
        ModifyClientRequest generated = gson.fromJson(str, ModifyClientRequest.class);
    ...
    public void dataTest() {
        ...
        ModifyClientRequest actual = new ModifyClientRequest();
