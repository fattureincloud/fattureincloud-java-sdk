...
public class ModifyArchiveDocumentRequestTest {
    private ModifyArchiveDocumentRequest model;

    @BeforeEach
    public void init() {
        model = new ModifyArchiveDocumentRequest()
    ...
    public void testModifyArchiveDocumentRequest() {
        ...
        ModifyArchiveDocumentRequest generated = gson.fromJson(str, ModifyArchiveDocumentRequest.class);
    ...
    public void dataTest() {
        ...
        ModifyArchiveDocumentRequest actual = new ModifyArchiveDocumentRequest();
