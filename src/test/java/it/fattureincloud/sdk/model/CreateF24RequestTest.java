...
public class CreateF24RequestTest {
    private CreateF24Request model;

    @BeforeEach
    public void init() {
        model = new CreateF24Request()
                .data(
                        new F24()
                                .id(12345)
    ...
    public void testCreateF24Request() {
        ...
        CreateF24Request generated = gson.fromJson(str, CreateF24Request.class);
    ...
    public void dataTest() {
        ...
        CreateF24Request actual = new CreateF24Request();
