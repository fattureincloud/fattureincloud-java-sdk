...
public class ListReceivedDocumentsResponsePageTest {
    private ListReceivedDocumentsResponsePage model;

    @BeforeEach
    public void init() {
        model = new ListReceivedDocumentsResponsePage()
                .addDataItem(
    ...
    public void dataTest() {
        ...
        ListReceivedDocumentsResponsePage actual = new ListReceivedDocumentsResponsePage();
