...
public class ListReceivedDocumentsResponsePageTest {
  ...
  public void init() {
    model =
        new ListReceivedDocumentsResponsePage()
            .addDataItem(
