...
public class ListIssuedDocumentsResponsePageTest {
    private ListIssuedDocumentsResponsePage model;

    @BeforeEach
    public void init() {
        model = new ListIssuedDocumentsResponsePage()
                .addDataItem(
                        new IssuedDocument()
                                .id(12345)
                                .notes("bando")
    ...
    public void testListIssuedDocumentsResponsePage() {
        ...
        ListIssuedDocumentsResponsePage generated = gson.fromJson(str, ListIssuedDocumentsResponsePage.class);
    ...
    public void dataTest() {
        ...
        ListIssuedDocumentsResponsePage actual = new ListIssuedDocumentsResponsePage();
