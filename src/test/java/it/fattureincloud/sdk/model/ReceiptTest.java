...
public class ReceiptTest {
  ...
  public void testReceipt() {
    ...
    String str =
        "{\"id\":10,\"date\":\"2021-12-25\",\"number\":10,\"numeration\":\"num\",\"amount_net\":10,\"amount_vat\":10,\"amount_gross\":10,\"use_gross_prices\":true,\"type\":\"till_receipt\",\"description\":\"descr\",\"rc_center\":\"bg\",\"created_at\":\"2021-10-10\",\"updated_at\":\"2021-10-10\",\"payment_account\":{\"id\":1,\"type\":\"standard\"},\"items_list\":[{\"id\":1}]}";
  ...
  public void itemsListTest() {
    ...
    assertEquals(
        Arrays.asList(new ReceiptItemsListItem().id(1), new ReceiptItemsListItem().id(2)),
        model.getItemsList());

    model.setItemsList(
        Arrays.asList(new ReceiptItemsListItem().id(3), new ReceiptItemsListItem().id(4)));
    Receipt a = model.paymentAccount(new PaymentAccount().id(1));
    Receipt expected =
        new Receipt()
            .id(10)
