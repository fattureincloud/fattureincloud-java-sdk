...
public class CreateClientResponseTest {
    private CreateClientResponse model;

    @BeforeEach
    public void init() {
        model = new CreateClientResponse()
                .data(
                        new Client()
                                .id(12345)
                                .code("AE86")
    ...
    public void testCreateClientResponse() {
        ...
        CreateClientResponse generated = gson.fromJson(str, CreateClientResponse.class);
    ...
    public void dataTest() {
        ...
        CreateClientResponse actual = new CreateClientResponse();
