...
public class GetClientResponseTest {
    private GetClientResponse model;

    @BeforeEach
    public void init() {
        model = new GetClientResponse()
                .data(
                        new Client()
                                .id(12345)
                                .code("AE86")
    ...
    public void testGetClientResponse() {
        ...
        GetClientResponse generated = gson.fromJson(str, GetClientResponse.class);
    ...
    public void dataTest() {
        ...
        GetClientResponse actual = new GetClientResponse();
