...
/**
 * Model tests for GetBinReceivedDocumentResponse
 */
public class GetBinReceivedDocumentResponseTest {
    private GetBinReceivedDocumentResponse model;

    @BeforeEach
    public void init() {
        model = new GetBinReceivedDocumentResponse()
            .data(new ReceivedDocument()
                .id(12345)
     ...
     */
    @Test
    public void testGetBinReceivedDocumentResponse() {
        ...
        GetBinReceivedDocumentResponse generated = gson.fromJson(str, GetBinReceivedDocumentResponse.class);
    ...
    public void dataTest() {
        ...
        model.setData(new ReceivedDocument().id(1));
        assertEquals(1, model.getData().getId());

        model.data(new ReceivedDocument().id(2));
        GetBinReceivedDocumentResponse actual = new GetBinReceivedDocumentResponse();
        actual.setData(new ReceivedDocument().id(2));
