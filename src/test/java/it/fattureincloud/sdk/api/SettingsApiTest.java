...
public class SettingsApiTest {
  ...
  private static SettingsApi mockApi(final String serializedBody, final Call remoteCall)
      throws IOException {
   ...
   *
   * <p>Creates a new payment account.
   *
  ...
  public void createPaymentAccountTest() throws ApiException, IOException {
    ...
    PaymentAccount expected = paymentAccount.id(21);

    CreatePaymentAccountRequest createPaymentAccountRequest =
        new CreatePaymentAccountRequest().data(paymentAccount);

    CreatePaymentAccountResponse response =
        api.createPaymentAccount(companyId, createPaymentAccountRequest);
   ...
   *
   * <p>Creates a new payment method.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void createPaymentMethodTest() throws ApiException, IOException {
    ...
    PaymentMethod expected = paymentMethod.id(12346).name("Bonifico bancario");

    CreatePaymentMethodRequest createPaymentMethodRequest =
        new CreatePaymentMethodRequest().data(paymentMethod);

    CreatePaymentMethodResponse response =
        api.createPaymentMethod(companyId, createPaymentMethodRequest);
  ...
  public void createVatTypeTest() throws ApiException, IOException {
    String result =
        "{\"data\":{\"id\":0,\"value\":22,\"description\":\"Non imponibile art."
            + " 123\",\"notes\":\"IVA non"
    ...
    VatType expected = vatType.id(0).notes("IVA non imponibile");
   ...
   *
   * <p>Deletes the specified payment account.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Deletes the specified payment method.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Delete Vat Type
   *
   * <p>Deletes the specified vat type.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   * Get Payment Account
   *
   * <p>Gets the specified payment account.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void getPaymentAccountTest() throws ApiException, IOException {
    ...
    GetPaymentAccountResponse response =
        api.getPaymentAccount(companyId, paymentAccountId, fields, fieldset);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
   ...
   * Get Payment Method
   *
   * <p>Gets the specified payment method.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void getPaymentMethodTest() throws ApiException, IOException {
    ...
    GetPaymentMethodResponse response =
        api.getPaymentMethod(companyId, paymentMethodId, fields, fieldset);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
   ...
   *
   * <p>Modifies the specified payment account.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void modifyPaymentAccountTest() throws ApiException, IOException {
    ...
    ModifyPaymentAccountRequest modifyPaymentAccountRequest =
        new ModifyPaymentAccountRequest().data(paymentAccount);

    ModifyPaymentAccountResponse response =
        api.modifyPaymentAccount(companyId, paymentAccountId, modifyPaymentAccountRequest);
   ...
   *
   * <p>Modifies the specified payment method.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void modifyPaymentMethodTest() throws ApiException, IOException {
    ...
    ModifyPaymentMethodRequest modifyPaymentMethodRequest =
        new ModifyPaymentMethodRequest().data(paymentMethod);

    ModifyPaymentMethodResponse response =
        api.modifyPaymentMethod(companyId, paymentMethodId, modifyPaymentMethodRequest);
   ...
   * Modify Vat Type
   *
   * <p>Modifies the specified vat type.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
