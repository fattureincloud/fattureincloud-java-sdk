...
public class ReceiptsApiTest {
  ...
  private static ReceiptsApi mockApi(final String serializedBody, final Call remoteCall)
      throws IOException {
  ...
  public void createReceiptTest() throws ApiException, IOException {
    String result =
        "{\"data\":{\"id\":10,\"date\":\"2021-12-25\",\"number\":10,\"numeration\":\"num\",\"amount_net\":10,\"amount_vat\":10,\"amount_gross\":10,\"use_gross_prices\":true,\"type\":\"till_receipt\",\"description\":\"descr\",\"rc_center\":\"bg\",\"created_at\":\"2021-10-10\",\"updated_at\":\"2021-10-10\",\"payment_account\":{\"id\":1,\"type\":\"standard\"},\"items_list\":[{\"id\":1}]}}";
    ...
    Receipt expected = receipt.id(10).numeration("num");
   ...
   * Delete Receipt
   *
   * <p>Deletes the specified receipt.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Retrieves the information useful while creating a new receipt.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Returns the monthly totals by year and receipt type.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void getReceiptsMonthlyTotalsTest() throws ApiException, IOException {
    ...
    GetReceiptsMonthlyTotalsResponse response =
        api.getReceiptsMonthlyTotals(companyId, "issued_documents", "2021");
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
  ...
  public void listReceiptsTest() throws ApiException, IOException {
    ...
    ListReceiptsResponse response =
        api.listReceipts(companyId, fields, fieldset, page, perPage, sort, q);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
   ...
   * Modify Receipt
   *
   * <p>Modifies the specified receipt.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void modifyReceiptTest() throws ApiException, IOException {
    ...
    ModifyReceiptResponse response =
        api.modifyReceipt(companyId, archiveDocumentId, modifyReceiptRequest);
