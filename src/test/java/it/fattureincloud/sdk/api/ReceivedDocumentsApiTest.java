...
public class ReceivedDocumentsApiTest {
  ...
  private static ReceivedDocumentsApi mockApi(final String serializedBody, final Call remoteCall)
      throws IOException {
  ...
  public void createReceivedDocumentTest() throws ApiException, IOException {
    ...
    ReceivedDocument expected = receivedDocument.id(1).category("cat6");

    CreateReceivedDocumentRequest createReceivedDocumentRequest =
        new CreateReceivedDocumentRequest().data(receivedDocument);

    CreateReceivedDocumentResponse response =
        api.createReceivedDocument(companyId, createReceivedDocumentRequest);
   ...
   *
   * <p>Returns the totals for the specified document.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void getExistingReceivedDocumentTotalsTest() throws ApiException, IOException {
    ...
    GetExistingReceivedDocumentTotalsRequest getExistingReceivedDocumentTotalsRequest =
        new GetExistingReceivedDocumentTotalsRequest();
    GetExistingReceivedDocumentTotalsResponse response =
        api.getExistingReceivedDocumentTotals(
            companyId, receivedDocumentId, getExistingReceivedDocumentTotalsRequest);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
  ...
  public void getNewReceivedDocumentTotalsTest() throws ApiException, IOException {
    ...
    GetNewReceivedDocumentTotalsRequest getNewReceivedDocumentTotalsRequest =
        new GetNewReceivedDocumentTotalsRequest()
            .data(
                new ReceivedDocument()
                    .id(12)
                    .type(ReceivedDocumentType.EXPENSE)
    ...
    GetNewReceivedDocumentTotalsResponse response =
        api.getNewReceivedDocumentTotals(companyId, getNewReceivedDocumentTotalsRequest);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
  ...
  public void getReceivedDocumentTest() throws ApiException, IOException {
    ...
    GetReceivedDocumentResponse response =
        api.getReceivedDocument(companyId, receivedDocumentId, fields, fieldset);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
  ...
  public void getReceivedDocumentPreCreateInfoTest() throws ApiException, IOException {
    ...
    ReceivedDocumentInfo receivedDocumentInfo =
    ...
    GetReceivedDocumentPreCreateInfoResponse response =
        api.getReceivedDocumentPreCreateInfo(companyId, "invoice");
   ...
   *
   * <p>Lists the received documents.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void listReceivedDocumentsTest() throws ApiException, IOException {
    ...
    ReceivedDocument receivedDocument1 =
        new ReceivedDocument()
            .id(1)
            .type(ReceivedDocumentType.EXPENSE)
            .entity(new Entity().id(1).name("neim"))
    ...
    ReceivedDocument receivedDocument2 =
        new ReceivedDocument()
            .id(1)
            .type(ReceivedDocumentType.EXPENSE)
            .entity(new Entity().id(1).name("neim"))
    ...
    ListReceivedDocumentsResponse expected =
    ...
    ListReceivedDocumentsResponse response =
        api.listReceivedDocuments(companyId, "invoice", null, null, null, null, null, null);
  ...
  public void modifyReceivedDocumentTest() throws ApiException, IOException {
    ...
    ModifyReceivedDocumentRequest modifyReceivedDocumentRequest =
        new ModifyReceivedDocumentRequest().data(expected);

    ModifyReceivedDocumentResponse response =
        api.modifyReceivedDocument(companyId, receivedDocumentId, modifyReceivedDocumentRequest);
   ...
   *
   * <p>Uploads an attachment destined to a received document. The actual association between the
  ...
  public void uploadReceivedDocumentAttachmentTest() throws ApiException, IOException {
    ...
    Integer companyId = 11111;
    AttachmentData expected =
        new AttachmentData()
            .attachmentToken("YmMyNWYxYzIwMTU3N212ABCDZjZiMzg5OWY0ODNkZDQveXl5LmRvYw");

    UploadReceivedDocumentAttachmentResponse response =
        api.uploadReceivedDocumentAttachment(companyId, "filename", null);
