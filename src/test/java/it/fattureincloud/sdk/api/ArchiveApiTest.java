...
public class ArchiveApiTest {
  ...
  private static ArchiveApi mockApi(final String serializedBody, final Call remoteCall)
      throws IOException {
   ...
   *
   * <p>Creates a new archive document.
   *
  ...
  public void createArchiveDocumentTest() throws ApiException, IOException {
    ...
    ArchiveDocument expected = archiveDocument.id(12345).description("spesa 2");

    CreateArchiveDocumentRequest createArchiveDocumentRequest =
        new CreateArchiveDocumentRequest().data(archiveDocument);

    CreateArchiveDocumentResponse response =
        api.createArchiveDocument(companyId, createArchiveDocumentRequest);
   ...
   *
   * <p>Deletes the specified archive document.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
   ...
   *
   * <p>Gets the specified archive document.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void getArchiveDocumentTest() throws ApiException, IOException {
    ...
    GetArchiveDocumentResponse response =
        api.getArchiveDocument(companyId, archiveDocumentId, fields, fieldset);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
  ...
  public void listArchiveDocumentsTest() throws ApiException, IOException {
    String result =
        "{\"current_page\":1,\"data\":[{\"id\":12345,\"date\":\"2021-08-20\",\"description\":\"spesa"
            + " 2\",\"category\":\"Altri"
            + " documenti\",\"attachment_token\":\"jwfbaiuwbfoiewfoa8weohafw7gefa9we\"},{\"id\":123456,\"date\":\"2021-08-20\",\"description\":\"spesa"
            + " 2\",\"category\":\"Altri"
            + " documenti\",\"attachment_token\":\"jwfbaiuwbfoiewfoa8weohafw7gefa9we\"}],\"first_page_url\":\"page=1\",\"from\":1,\"last_page\":2,\"last_page_url\":\"page=2\",\"next_page_url\":\"page=2\",\"path\":\"entities/clients\",\"per_page\":5,\"prev_page_url\":null,\"to\":50,\"total\":8}";
    ...
    ArchiveDocument archiveDocument1 =
        new ArchiveDocument()
            .id(12345)
            .date(LocalDate.parse("2021-08-20"))
            .category("Altri documenti")
    ...
    ArchiveDocument archiveDocument2 =
        new ArchiveDocument()
            .id(123456)
            .date(LocalDate.parse("2021-08-20"))
            .category("Altri documenti")
    ...
    ListArchiveDocumentsResponse response =
        api.listArchiveDocuments(companyId, fields, fieldset, sort, page, perPage, q);
    assertEquals(expected, response.getData());
    Mockito.verify(mockCall, Mockito.only()).execute();
  }
   ...
   *
   * <p>Modifies the specified archive document.
   *
   * @throws ApiException if the Api call fails
   */
  @Test
  public void modifyArchiveDocumentTest() throws ApiException, IOException {
    ...
    ModifyArchiveDocumentRequest modifyArchiveDocumentRequest =
        new ModifyArchiveDocumentRequest().data(archiveDocument);

    ModifyArchiveDocumentResponse response =
        api.modifyArchiveDocument(companyId, archiveDocumentId, modifyArchiveDocumentRequest);
   ...
   *
   * <p>Uploads an attachment destined to an archive document. The actual association between the
  ...
  public void uploadArchiveDocumentAttachmentTest() throws ApiException, IOException {
    ...
    Integer companyId = 11111;
    UploadArchiveAttachmentResponse expected =
        new UploadArchiveAttachmentResponse()
            .data(
                new AttachmentData()
                    .attachmentToken("YmMyNWYxYzIwMTU3N212ABCDZjZiMzg5OWY0ODNkZDQveXl5LmRvYw"));

    UploadArchiveAttachmentResponse response =
        api.uploadArchiveDocumentAttachment(companyId, "filename", null);
