...
public class FilterTest {
    ...
    public void testAnd() throws Exception {
        ...
        Assertions.assertEquals("Cannot create a conjunction for an empty expression.", thrown.getMessage());
    ...
    public void testAndExpression() throws Exception {
        ...
        Exception thrownLeft = Assertions.assertThrows(Exception.class, () -> {
            f.andExpression(c2);
        });

        Assertions.assertEquals("Cannot create a conjunction for an empty expression.", thrownLeft.getMessage());

        Exception thrownRight = Assertions.assertThrows(Exception.class, () -> {
            f.whereExpression(c1).andExpression(null);
        });

        Assertions.assertEquals("Cannot create a conjunction for an empty expression.", thrownRight.getMessage());
    ...
    public void testAndFilter() throws Exception {
        ...
        Exception thrownNull = Assertions.assertThrows(Exception.class, () -> {
            f.whereExpression(c1).andFilter(null);
        });

        Assertions.assertEquals("Cannot create a conjunction for an empty expression.", thrownNull.getMessage());
    ...
    public void testOr() throws Exception {
        ...
        Assertions.assertEquals("Cannot create a disjunction for an empty expression.", thrown.getMessage());
    ...
    public void testOrExpression() throws Exception {
        ...
        Assertions.assertEquals("Cannot create a disjunction for an empty expression.", thrownLeft.getMessage());

        Exception thrownRight = Assertions.assertThrows(Exception.class, () -> {
            f.whereExpression(c1).orExpression(null);
        });

        Assertions.assertEquals("Cannot create a disjunction for an empty expression.", thrownRight.getMessage());
    ...
    public void testOrFilter() throws Exception {
        ...
        Assertions.assertEquals("Cannot create a disjunction for an empty expression.", thrownNull.getMessage());
