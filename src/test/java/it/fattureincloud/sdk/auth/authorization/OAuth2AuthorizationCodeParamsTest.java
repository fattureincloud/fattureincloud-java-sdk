...
public class OAuth2AuthorizationCodeParamsTest {
  ...
  public void testOAuth2AuthorizationCodeParams() {
    OAuth2AuthorizationCodeParams params =
        new OAuth2AuthorizationCodeParams("I_HAVE_COVID", "c/STAY_AWAY_FROM_ME");
    ...
    OAuth2AuthorizationCodeParams generated =
        gson.fromJson(str, OAuth2AuthorizationCodeParams.class);
